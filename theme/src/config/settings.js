export default {
	title: `Robotics - Telematics Engineering | Carlos Nebril`,
	...
	name: `Robotics`, // The short name of the business or brand name. Used for things like the copyright in the footer.
